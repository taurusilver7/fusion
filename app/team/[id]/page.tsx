...
import getFixturesByTeamId from "@/utils/getFixturesByTeamId";
import getTeamInfoByTeamId from "@/utils/getTeamInfoByTeamId";
	...
	return (
		<div className="flex justify-center items-center text-neutral-100 py-5">
			<div className="flex flex-col max-w-7xl p-5 w-full md:flex-row">
				<div className="flex flex-col md:w-1/3 justify-center items-center bg-gradient-to-r from-black/60 to-red-900/80 h-[500px]">
					<Image
