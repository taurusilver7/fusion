...
import getFixturesByFixtureId from "@/utils/getFixturesByFixtureId";
...
const MatchPage = async ({ params }: PageProps) => {
	...
	return (
		<div className="flex flex-col w-full justify-center items-center py-10 md:p-10 text-neutral-100">
			<div className="flex w-full max-w-7xl items-center justify-center perspective pb-8 md:pb-16">
